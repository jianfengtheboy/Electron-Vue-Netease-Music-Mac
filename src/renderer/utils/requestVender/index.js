 ...
 * @Date: 2021-07-06 14:24:02
 * @LastEditTime: 2021-07-06 18:28:21
 */
...
function requestCreateFactory(config) {
  const instance = new RequestVender(config)
  const result = RequestVender.prototype.request.bind(instance)
  result.request = RequestVender.prototype.request.bind(instance)
  result.get = RequestVender.prototype.get.bind(instance)
  result.post = RequestVender.prototype.post.bind(instance)
  Object.setPrototypeOf(result, instance)
  return result
}

const requestFn = requestCreateFactory(DEFAULTS)

requestFn.create = function (config) {
  return requestCreateFactory(deepMerge(DEFAULTS, config))
}
