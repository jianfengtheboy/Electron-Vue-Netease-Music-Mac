 ...
 * @Date: 2021-07-10 22:59:21
 * @LastEditTime: 2021-07-11 17:43:10
-->
<template>
    <a-popover
      trigger="click"
      ...
      >
        <template slot="content">
          ...
          <div class="search-content" v-else>
            <dl>
              <dt> 热门搜索 </dt>
              <dd v-for="(hot, index) in hots" :key="index" @click="setKeyword(hot.first)">{{ hot.first }}</dd>
            </dl>
            <dl>
...
export default {
  ...
  computed: {
    ...
    overlayStyle() {
      return this.keyword && this.suggests ? { width: "200px", top: "50px" } : { width: "440px", top: "50px" }
    }
  },
  created() {
    this.$watch(
