 ...
 * @Date: 2021-07-10 21:05:53
 * @LastEditTime: 2021-07-10 23:01:14
-->
<template>
  <a-popover
  ...
  >
    <template slot="content">
      <div class="colorBlock">
        ...
        >
          <zicon type="wangyiyunyinle1" class="z-icon"></zicon>
...
import zicon from '@/baseComponents/zicon'
...
export default {
  ...
  created() {
    let key = process.env.NODE_ENV === 'development' ? `${window.location.origin}/less/color.less`
